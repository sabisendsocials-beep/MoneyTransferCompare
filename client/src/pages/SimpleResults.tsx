...
import { SimpleComparisonCard } from "@/components/SimpleComparisonCard";
  ...
  return (
    <div className="max-w-6xl mx-auto py-6 px-4">
      ...
      {loading ? (
        ...
        <>
          <p className="text-sm text-gray-500 mb-4">Found {results.length} providers for your transfer</p>
