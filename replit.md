...
- **AI-Powered Forecasting**: Uses OpenAI GPT to analyze 60 days of historical rate data and identify patterns, trends, and cycles. No hardcoded formulas - AI learns from actual market data. Predictions include confidence levels and reasoning explanations. Results cached for 4 hours to manage API costs.
