...
- **AI-Powered Forecasting**: Uses OpenAI GPT to analyze up to 2 years of historical rate data, including seasonal patterns, multi-timeframe averages, and trend analysis. No hardcoded formulas - AI learns from actual market data. Predictions include confidence levels and reasoning explanations. Results cached for 20 hours to manage API costs.
