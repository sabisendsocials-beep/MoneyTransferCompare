    ...
    const sampleProviders: InsertProvider[] = [
      {
        ...
        scrapingUrl: "https://wise.com/gb/currency-converter/gbp-to-ngn-rate",
        scrapingSelector: ".cc__source-to-target",
      ...
      },
      {
        ...
        scrapingUrl: "https://www.westernunion.com/gb/en/currency-converter/gbp-to-ngn-rate.html",
        scrapingSelector: ".exchange-rate",
      ...
      },
      {
        ...
        scrapingUrl: "https://www.moneygram.com/mgo/gb/en/exchange-rate-calculator",
        scrapingSelector: ".exchange-rate-value",
        transferTime: "Minutes (cash pickup)",
        hasFixedFee: true,
        fixedFee: 5.99,
        percentageFee: 1.5,
        active: true
      },
      {
        ...
        scrapingUrl: "https://www.remitly.com/gb/en/nigeria/pricing",
        scrapingSelector: ".exchange-rate-value",
