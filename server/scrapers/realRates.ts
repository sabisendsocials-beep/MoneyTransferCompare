...
export const realProviderRates = [
  ...
  // New providers
  { name: 'Lemfi', fromCurrency: 'GBP', toCurrency: 'NGN', rate: 2139.00, fee: 0.00, transferTime: 'Minutes', rating: 4.7 },
  ...
  { name: 'Lemfi', fromCurrency: 'EUR', toCurrency: 'NGN', rate: 1805.35, fee: 0.00, transferTime: 'Minutes', rating: 4.7 },
